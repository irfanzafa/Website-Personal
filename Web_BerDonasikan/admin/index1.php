...
<!-- Navbar -->
<nav class="navbar">
            <a href="javascrip:void()" class="navbar-logo">BerDonasikan.</a>
            <div class="navbar-a">
                <a href="<?php echo "?p=home"; ?>">Home</a>
                <a href="<?php echo "?p=konten"; ?>">Konten</a>
                <a href="<?php echo "?p=katmodul"; ?>">Kategori Modul</a>
                <a href="<?php echo "?p=modul"; ?>">Modul</a>
...
<div class="grid">
        ...
        <footer>
            <div class="credit">
                <p>Created by <a href="https://instagram.com/hanarfi_k?igshid=ZDdkNTZiNTM=">R.</a> 
                <a href="https://instagram.com/your.bae.18?igshid=ZDc4ODBmNjlmNQ==">B.</a> 
                <a href="">F.</a>  | @copy; 2024. </p>
            </div>
        </footer>
        <!-- Footer Done-->
        <!-- Icons -->
